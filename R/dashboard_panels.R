                      ...
                      tabPanel(
                        ...
                        fluidRow(
                          column(
                            ...
                            br(),
                            numericInput("ebaccscoresci", p("Enter the pupil's score in the science EBacc element:"), 0, min = 0, max = 9, step = 0.01),
                          ...
                          br(),
                          numericInput("ebaccscorelan", p("Enter the pupil's score in the languages EBacc element:"), 0, min = 0, max = 9, step = 0.01),
